...
/** Data Packet Flags. Currently only flushability is defined.
...
/* User DRB may be released callback prototype. This function address is passed
...
*/
typedef void (wiced_bt_l2cap_drb_release_cb) (tDRB *);
...
/**
*
*  Function         wiced_bt_l2cap_register_ertm_drb
*
 ...
 *  @param[in]      flags: L2CAP_FLUSHABLE_PACKET
