...
#ifndef WICED_BT_A2DP_SINK_CO_M12_SUPPORT
...
typedef enum
{
    WICED_BT_A2DP_SINK_FEAT_NONE      = 0x0000, /**< None */
...
typedef struct
{
    uint8_t  *p_rx_media;       /**< Audio data packet */
    uint16_t media_len;         /**< Sequence number */
...
*   p_audio_data contains raw PCM samples in case of SBC codec and encoded audio data
