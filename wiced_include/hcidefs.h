...
*/
#define HCI_PROTO_VERSION     0x01U      /* Version for Bluetooth spec 1.1          */
#define HCI_PROTO_VERSION_1_2 0x02U      /* Version for Bluetooth spec 1.2          */
#define HCI_PROTO_VERSION_2_0 0x03U      /* Version for Bluetooth spec 2.0          */
#define HCI_PROTO_VERSION_2_1 0x04U      /* Version for Bluetooth spec 2.1 [Lisbon] */
#define HCI_PROTO_VERSION_3_0 0x05U      /* Version for Bluetooth spec 3.0          */
#define HCI_PROTO_VERSION_4_0 0x06U      /* Version for Bluetooth spec 4.0 [LE]     */
#define HCI_PROTO_VERSION_4_1 0x07U      /* Version for Bluetooth spec 4.1          */
#define HCI_PROTO_VERSION_4_2 0x08U      /* Version for Bluetooth spec 4.2          */
#define HCI_PROTO_VERSION_5_0 0x09U      /* Version for Bluetooth spec 5.0          */
#define HCI_PROTO_VERSION_5_1 0x0AU      /* Version for Bluetooth spec 5.1          */
#define HCI_PROTO_VERSION_5_2 0x0BU      /* Version for Bluetooth spec 5.2          */
#define HCI_PROTO_VERSION_5_3 0x0CU      /* Version for Bluetooth spec 5.3          */

/*
**  Definitions for HCI groups
*/
#define HCI_GRP_LINK_CONTROL_CMDS       ((uint16_t)0x01U << 10)            /* 0x0400 */
#define HCI_GRP_LINK_POLICY_CMDS        ((uint16_t)0x02U << 10)            /* 0x0800 */
#define HCI_GRP_HOST_CONT_BASEBAND_CMDS ((uint16_t)0x03U << 10)            /* 0x0C00 */
#define HCI_GRP_INFORMATIONAL_PARAMS    ((uint16_t)0x04U << 10)            /* 0x1000 */
#define HCI_GRP_STATUS_PARAMS           ((uint16_t)0x05U << 10)            /* 0x1400 */
#define HCI_GRP_TESTING_CMDS            ((uint16_t)0x06U << 10)            /* 0x1800 */

#define HCI_GRP_VENDOR_SPECIFIC         ((uint16_t)0x3FU << 10)            /* 0xFC00 */

/* Group occupies high 6 bits of the HCI command rest is opcode itself */
#define HCI_OGF(p)  (uint8_t)((0xFC00U & (p)) >> 10)
#define HCI_OCF(p)  ( 0x3FFU & (p))
...
#define HCI_INQUIRY                     (0x0001U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0401 */
#define HCI_INQUIRY_CANCEL              (0x0002U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0402 */
#define HCI_PERIODIC_INQUIRY_MODE       (0x0003U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0403 */
#define HCI_EXIT_PERIODIC_INQUIRY_MODE  (0x0004U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0404 */
#define HCI_CREATE_CONNECTION           (0x0005U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0405 */
#define HCI_DISCONNECT                  (0x0006U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0406 */
#define HCI_ADD_SCO_CONNECTION          (0x0007U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0407 */
#define HCI_CREATE_CONNECTION_CANCEL    (0x0008U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0408 */
#define HCI_ACCEPT_CONNECTION_REQUEST   (0x0009U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0409 */
#define HCI_REJECT_CONNECTION_REQUEST   (0x000AU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040A */
#define HCI_LINK_KEY_REQUEST_REPLY      (0x000BU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040B */
#define HCI_LINK_KEY_REQUEST_NEG_REPLY  (0x000CU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040C */
#define HCI_PIN_CODE_REQUEST_REPLY      (0x000DU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040D */
#define HCI_PIN_CODE_REQUEST_NEG_REPLY  (0x000EU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040E */
#define HCI_CHANGE_CONN_PACKET_TYPE     (0x000FU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x040F */
#define HCI_AUTHENTICATION_REQUESTED    (0x0011U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0411 */
#define HCI_SET_CONN_ENCRYPTION         (0x0013U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0413 */
#define HCI_CHANGE_CONN_LINK_KEY        (0x0015U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0415 */
#define HCI_TEMP_LINK_KEY               (0x0017U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0417 */
#define HCI_RMT_NAME_REQUEST            (0x0019U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0419 */
#define HCI_RMT_NAME_REQUEST_CANCEL     (0x001AU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x041A */
#define HCI_READ_RMT_FEATURES           (0x001BU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x041B */
#define HCI_READ_RMT_EXT_FEATURES       (0x001CU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x041C */
#define HCI_READ_RMT_VERSION_INFO       (0x001DU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x041D */
#define HCI_READ_RMT_CLOCK_OFFSET       (0x001FU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x041F */
#define HCI_READ_LMP_HANDLE             (0x0020U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0420 */
#define HCI_SETUP_ESCO_CONNECTION       (0x0028U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0428 */
#define HCI_ACCEPT_ESCO_CONNECTION      (0x0029U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0429 */
#define HCI_REJECT_ESCO_CONNECTION      (0x002AU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042A */
#define HCI_IO_CAPABILITY_REQUEST_REPLY (0x002BU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042B */
#define HCI_USER_CONF_REQUEST_REPLY     (0x002CU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042C */
#define HCI_USER_CONF_VALUE_NEG_REPLY   (0x002DU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042D */
#define HCI_USER_PASSKEY_REQ_REPLY      (0x002EU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042E */
#define HCI_USER_PASSKEY_REQ_NEG_REPLY  (0x002FU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x042F */
#define HCI_REM_OOB_DATA_REQ_REPLY      (0x0030U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0430 */
#define HCI_REM_OOB_DATA_REQ_NEG_REPLY  (0x0033U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0433 */
#define HCI_IO_CAP_REQ_NEG_REPLY        (0x0034U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0434 */

/* AMP HCI */
#define HCI_CREATE_PHYSICAL_LINK        (0x0035U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0435 */
#define HCI_ACCEPT_PHYSICAL_LINK        (0x0036U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0436 */
#define HCI_DISCONNECT_PHYSICAL_LINK    (0x0037U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0437 */
#define HCI_CREATE_LOGICAL_LINK         (0x0038U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0438 */
#define HCI_ACCEPT_LOGICAL_LINK         (0x0039U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0439 */
#define HCI_DISCONNECT_LOGICAL_LINK     (0x003AU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043A */
#define HCI_LOGICAL_LINK_CANCEL         (0x003BU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043B */
#define HCI_FLOW_SPEC_MODIFY            (0x003CU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043C */
/* End of AMP HCI */

#define HCI_ENH_SETUP_ESCO_CONNECTION   (0x003DU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043D */
#define HCI_ENH_ACCEPT_ESCO_CONNECTION  (0x003EU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043E */

/* ConnectionLess Broadcast */
#define HCI_TRUNCATED_PAGE              (0x003FU | HCI_GRP_LINK_CONTROL_CMDS) /* 0x043F */
#define HCI_TRUNCATED_PAGE_CANCEL       (0x0040U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0440 */
#define HCI_SET_CLB                     (0x0041U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0441 */
#define HCI_RECEIVE_CLB                 (0x0042U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0442 */
#define HCI_START_SYNC_TRAIN            (0x0043U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0443 */
#define HCI_RECEIVE_SYNC_TRAIN          (0x0044U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0444 */

/* Secure Connections (SC)*/
#define HCI_REM_OOB_EXT_DATA_REQ_REPLY  (0x0045U | HCI_GRP_LINK_CONTROL_CMDS) /* 0x0445 */
...
#define HCI_HOLD_MODE                   (0x0001U | HCI_GRP_LINK_POLICY_CMDS) /* 0x0801 */
#define HCI_SNIFF_MODE                  (0x0003U | HCI_GRP_LINK_POLICY_CMDS) /* 0x0803 */
#define HCI_EXIT_SNIFF_MODE             (0x0004U | HCI_GRP_LINK_POLICY_CMDS) /* 0x0804 */
#define HCI_PARK_MODE                   (0x0005U | HCI_GRP_LINK_POLICY_CMDS) /* 0x0805 */
#define HCI_EXIT_PARK_MODE              (0x0006U | HCI_GRP_LINK_POLICY_CMDS) /* 0x0806 */
#define HCI_QOS_SETUP                   (0x0007U | HCI_GRP_LINK_POLICY_CMDS) /* 0x0807 */
#define HCI_ROLE_DISCOVERY              (0x0009U | HCI_GRP_LINK_POLICY_CMDS) /* 0x0809 */
#define HCI_SWITCH_ROLE                 (0x000BU | HCI_GRP_LINK_POLICY_CMDS) /* 0x080B */
#define HCI_READ_POLICY_SETTINGS        (0x000CU | HCI_GRP_LINK_POLICY_CMDS) /* 0x080C */
#define HCI_WRITE_POLICY_SETTINGS       (0x000DU | HCI_GRP_LINK_POLICY_CMDS) /* 0x080D */
#define HCI_READ_DEF_POLICY_SETTINGS    (0x000EU | HCI_GRP_LINK_POLICY_CMDS) /* 0x080E */
#define HCI_WRITE_DEF_POLICY_SETTINGS   (0x000FU | HCI_GRP_LINK_POLICY_CMDS) /* 0x080F */
#define HCI_FLOW_SPECIFICATION          (0x0010U | HCI_GRP_LINK_POLICY_CMDS) /* 0x0810 */
#define HCI_SNIFF_SUB_RATE              (0x0011U | HCI_GRP_LINK_POLICY_CMDS) /* 0x0811 */
...
#define HCI_SET_EVENT_MASK              (0x0001U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_RESET                       (0x0003U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_SET_EVENT_FILTER            (0x0005U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_FLUSH                       (0x0008U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_PIN_TYPE               (0x0009U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_PIN_TYPE              (0x000AU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_CREATE_NEW_UNIT_KEY         (0x000BU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)

#define HCI_READ_STORED_LINK_KEY        (0x000DU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_STORED_LINK_KEY       (0x0011U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_DELETE_STORED_LINK_KEY      (0x0012U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_CHANGE_LOCAL_NAME           (0x0013U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_LOCAL_NAME             (0x0014U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_CONN_ACCEPT_TOUT       (0x0015U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_CONN_ACCEPT_TOUT      (0x0016U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_PAGE_TOUT              (0x0017U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_PAGE_TOUT             (0x0018U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_SCAN_ENABLE            (0x0019U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_SCAN_ENABLE           (0x001AU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_PAGESCAN_CFG           (0x001BU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_PAGESCAN_CFG          (0x001CU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_INQUIRYSCAN_CFG        (0x001DU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_INQUIRYSCAN_CFG       (0x001EU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_AUTHENTICATION_ENABLE  (0x001FU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_AUTHENTICATION_ENABLE (0x0020U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_ENCRYPTION_MODE        (0x0021U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_ENCRYPTION_MODE       (0x0022U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_CLASS_OF_DEVICE        (0x0023U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_CLASS_OF_DEVICE       (0x0024U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_VOICE_SETTINGS         (0x0025U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_VOICE_SETTINGS        (0x0026U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_AUTO_FLUSH_TOUT        (0x0027U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_AUTO_FLUSH_TOUT       (0x0028U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_NUM_BCAST_REXMITS      (0x0029U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_NUM_BCAST_REXMITS     (0x002AU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_HOLD_MODE_ACTIVITY     (0x002BU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_HOLD_MODE_ACTIVITY    (0x002CU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_TRANSMIT_POWER_LEVEL   (0x002DU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_SCO_FLOW_CTRL_ENABLE   (0x002EU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_SCO_FLOW_CTRL_ENABLE  (0x002FU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_SET_HC_TO_HOST_FLOW_CTRL    (0x0031U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_HOST_BUFFER_SIZE            (0x0033U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_HOST_NUM_PACKETS_DONE       (0x0035U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_LINK_SUPER_TOUT        (0x0036U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_LINK_SUPER_TOUT       (0x0037U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_NUM_SUPPORTED_IAC      (0x0038U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_CURRENT_IAC_LAP        (0x0039U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_CURRENT_IAC_LAP       (0x003AU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_PAGESCAN_PERIOD_MODE   (0x003BU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_PAGESCAN_PERIOD_MODE  (0x003CU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_PAGESCAN_MODE          (0x003DU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_PAGESCAN_MODE         (0x003EU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_SET_AFH_CHANNELS            (0x003FU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)

#define HCI_READ_INQSCAN_TYPE           (0x0042U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_INQSCAN_TYPE          (0x0043U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_INQUIRY_MODE           (0x0044U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_INQUIRY_MODE          (0x0045U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_PAGESCAN_TYPE          (0x0046U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_PAGESCAN_TYPE         (0x0047U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_AFH_ASSESSMENT_MODE    (0x0048U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_AFH_ASSESSMENT_MODE   (0x0049U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_EXT_INQ_RESPONSE       (0x0051U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_EXT_INQ_RESPONSE      (0x0052U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_REFRESH_ENCRYPTION_KEY      (0x0053U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_SIMPLE_PAIRING_MODE    (0x0055U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_SIMPLE_PAIRING_MODE   (0x0056U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_LOCAL_OOB_DATA         (0x0057U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_INQ_TX_POWER_LEVEL     (0x0058U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_INQ_TX_POWER_LEVEL    (0x0059U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_ERRONEOUS_DATA_RPT     (0x005AU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_ERRONEOUS_DATA_RPT    (0x005BU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_ENHANCED_FLUSH              (0x005FU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_SEND_KEYPRESS_NOTIF         (0x0060U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)

#define HCI_READ_LOGICAL_LINK_ACCEPT_TIMEOUT    (0x0061U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_LOGICAL_LINK_ACCEPT_TIMEOUT   (0x0062U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_SET_EVENT_MASK_PAGE_2               (0x0063U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_LOCATION_DATA                  (0x0064U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_LOCATION_DATA                 (0x0065U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_FLOW_CONTROL_MODE              (0x0066U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_FLOW_CONTROL_MODE             (0x0067U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_BE_FLUSH_TOUT                  (0x0069U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_BE_FLUSH_TOUT                 (0x006AU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_SHORT_RANGE_MODE                    (0x006BU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_LE_HOST_SUPPORTED              (0x006CU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_LE_HOST_SUPPORTED             (0x006DU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)


/* MWS coexistence */
#define HCI_SET_MWS_CHANNEL_PARAMETERS          (0x006EU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_SET_EXTERNAL_FRAME_CONFIGURATION    (0x006FU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_SET_MWS_SIGNALING                   (0x0070U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_SET_MWS_TRANSPORT_LAYER             (0x0071U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_SET_MWS_SCAN_FREQUENCY_TABLE        (0x0072U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_SET_MWS_PATTERN_CONFIGURATION       (0x0073U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)

/* ConnectionLess Broadcast */
#define HCI_SET_RESERVED_LT_ADDR                (0x0074U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_DELETE_RESERVED_LT_ADDR             (0x0075U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_CLB_DATA                      (0x0076U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_SYNC_TRAIN_PARAM               (0x0077U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_SYNC_TRAIN_PARAM              (0x0078U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)

/* Secure Connections (SC)*/
#define HCI_READ_SECURE_CONNS_SUPPORT           (0x0079U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_SECURE_CONNS_SUPPORT          (0x007AU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_AUTHENT_PAYLOAD_TOUT           (0x007BU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_WRITE_AUTHENT_PAYLOAD_TOUT          (0x007CU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_READ_LOCAL_OOB_EXT_DATA             (0x007DU | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
#define HCI_CONFIGURE_DATA_PATH                 (0X0083U | HCI_GRP_HOST_CONT_BASEBAND_CMDS)
...
#define HCI_READ_LOCAL_VERSION_INFO     (0x0001U | HCI_GRP_INFORMATIONAL_PARAMS)
#define HCI_READ_LOCAL_SUPPORTED_CMDS   (0x0002U | HCI_GRP_INFORMATIONAL_PARAMS)
#define HCI_READ_LOCAL_FEATURES         (0x0003U | HCI_GRP_INFORMATIONAL_PARAMS)
#define HCI_READ_LOCAL_EXT_FEATURES     (0x0004U | HCI_GRP_INFORMATIONAL_PARAMS)
#define HCI_READ_BUFFER_SIZE            (0x0005U | HCI_GRP_INFORMATIONAL_PARAMS)
#define HCI_READ_COUNTRY_CODE           (0x0007U | HCI_GRP_INFORMATIONAL_PARAMS)
#define HCI_READ_BD_ADDR                (0x0009U | HCI_GRP_INFORMATIONAL_PARAMS)
#define HCI_READ_DATA_BLOCK_SIZE        (0x000AU | HCI_GRP_INFORMATIONAL_PARAMS)
#define HCI_READ_LOCAL_SUPPORTED_CODECS (0x000BU | HCI_GRP_INFORMATIONAL_PARAMS)
...
#define HCI_READ_FAILED_CONTACT_COUNT   (0x0001U | HCI_GRP_STATUS_PARAMS)
#define HCI_RESET_FAILED_CONTACT_COUNT  (0x0002U | HCI_GRP_STATUS_PARAMS)
#define HCI_GET_LINK_QUALITY            (0x0003U | HCI_GRP_STATUS_PARAMS)
#define HCI_READ_RSSI                   (0x0005U | HCI_GRP_STATUS_PARAMS)
#define HCI_READ_AFH_CH_MAP             (0x0006U | HCI_GRP_STATUS_PARAMS)
#define HCI_READ_CLOCK                  (0x0007U | HCI_GRP_STATUS_PARAMS)
#define HCI_READ_ENCR_KEY_SIZE          (0x0008U | HCI_GRP_STATUS_PARAMS)

/* AMP HCI */
#define HCI_READ_LOCAL_AMP_INFO         (0x0009U | HCI_GRP_STATUS_PARAMS)
#define HCI_READ_LOCAL_AMP_ASSOC        (0x000AU | HCI_GRP_STATUS_PARAMS)
#define HCI_WRITE_REMOTE_AMP_ASSOC      (0x000BU | HCI_GRP_STATUS_PARAMS)

/* MWS coexistence */
#define HCI_GET_MWS_TRANS_LAYER_CFG     (0x000CU | HCI_GRP_STATUS_PARAMS)

/* CSA4 (Trigger Clock) */
#define HCI_SET_TRIGGERED_CLOCK_CAPTURE (0x000DU | HCI_GRP_STATUS_PARAMS)
...
#define HCI_READ_LOOPBACK_MODE          (0x0001U | HCI_GRP_TESTING_CMDS)
#define HCI_WRITE_LOOPBACK_MODE         (0x0002U | HCI_GRP_TESTING_CMDS)
#define HCI_ENABLE_DEV_UNDER_TEST_MODE  (0x0003U | HCI_GRP_TESTING_CMDS)
#define HCI_WRITE_SIMP_PAIR_DEBUG_MODE  (0x0004U | HCI_GRP_TESTING_CMDS)

/* AMP HCI */
#define HCI_ENABLE_AMP_RCVR_REPORTS     (0x0007U | HCI_GRP_TESTING_CMDS)
#define HCI_AMP_TEST_END                (0x0008U | HCI_GRP_TESTING_CMDS)
#define HCI_AMP_TEST                    (0x0009U | HCI_GRP_TESTING_CMDS)

/* Secure Connections (SC)*/
#define HCI_WRITE_SECURE_CONNS_TEST_MODE    (0x000AU | HCI_GRP_TESTING_CMDS)
...
#define HCI_VSC_READ_VERBOSE_CONFIG_VERSION_INFO        0xFC79

/* LE HCI */
#define HCI_GRP_BLE_CMDS                ((uint16_t)0x08U << 10) /* 0x2000*/
/* Commands of LE Controller setup and configuration */
#define HCI_BLE_SET_EVENT_MASK          (0x0001U | HCI_GRP_BLE_CMDS) /* 0x2001 */
#define HCI_BLE_READ_BUFFER_SIZE        (0x0002U | HCI_GRP_BLE_CMDS) /* 0x2002 */
#define HCI_BLE_READ_LOCAL_SPT_FEAT     (0x0003U | HCI_GRP_BLE_CMDS) /* 0x2003 */
//#define HCI_BLE_WRITE_LOCAL_SPT_FEAT    (0x0004U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_WRITE_RANDOM_ADDR       (0x0005U | HCI_GRP_BLE_CMDS) /* 0x2005 */
#define HCI_BLE_WRITE_ADV_PARAMS        (0x0006U | HCI_GRP_BLE_CMDS) /* 0x2006 */
#define HCI_BLE_READ_ADV_CHNL_TX_POWER  (0x0007U | HCI_GRP_BLE_CMDS) /* 0x2007 */
#define HCI_BLE_WRITE_ADV_DATA          (0x0008U | HCI_GRP_BLE_CMDS) /* 0x2008 */
#define HCI_BLE_WRITE_SCAN_RSP_DATA     (0x0009U | HCI_GRP_BLE_CMDS) /* 0x2009 */
#define HCI_BLE_WRITE_ADV_ENABLE        (0x000AU | HCI_GRP_BLE_CMDS) /* 0x200A */
#define HCI_BLE_WRITE_SCAN_PARAMS       (0x000BU | HCI_GRP_BLE_CMDS) /* 0x200B */
#define HCI_BLE_WRITE_SCAN_ENABLE       (0x000CU | HCI_GRP_BLE_CMDS) /* 0x200C */
#define HCI_BLE_CREATE_LL_CONN          (0x000DU | HCI_GRP_BLE_CMDS) /* 0x200D */
#define HCI_BLE_CREATE_CONN_CANCEL      (0x000EU | HCI_GRP_BLE_CMDS) /* 0x200E */
#define HCI_BLE_READ_FILTER_ACCEPT_LIST_SIZE    (0x000FU | HCI_GRP_BLE_CMDS) /* 0x200F */
#define HCI_BLE_CLEAR_FILTER_ACCEPT_LIST        (0x0010U | HCI_GRP_BLE_CMDS) /* 0x2010 */
#define HCI_BLE_ADD_FILTER_ACCEPT_LIST          (0x0011U | HCI_GRP_BLE_CMDS) /* 0x2011 */
#define HCI_BLE_REMOVE_FILTER_ACCEPT_LIST       (0x0012U | HCI_GRP_BLE_CMDS) /* 0x2012 */
#define HCI_BLE_UPD_LL_CONN_PARAMS              (0x0013U | HCI_GRP_BLE_CMDS) /* 0x2013 */
#define HCI_BLE_SET_HOST_CHNL_CLASS             (0x0014U | HCI_GRP_BLE_CMDS) /* 0x2014 */
#define HCI_BLE_READ_CHNL_MAP                   (0x0015U | HCI_GRP_BLE_CMDS) /* 0x2015 */
#define HCI_BLE_READ_REMOTE_FEAT                (0x0016U | HCI_GRP_BLE_CMDS) /* 0x2016 */
#define HCI_BLE_ENCRYPT                         (0x0017U | HCI_GRP_BLE_CMDS) /* 0x2017 */
#define HCI_BLE_RAND                            (0x0018U | HCI_GRP_BLE_CMDS) /* 0x2018 */
#define HCI_BLE_START_ENC                       (0x0019U | HCI_GRP_BLE_CMDS) /* 0x2019 */
#define HCI_BLE_LTK_REQ_REPLY                   (0x001AU | HCI_GRP_BLE_CMDS) /* 0x201A */
#define HCI_BLE_LTK_REQ_NEG_REPLY               (0x001BU | HCI_GRP_BLE_CMDS) /* 0x201B */
#define HCI_BLE_READ_SUPPORTED_STATES           (0x001CU | HCI_GRP_BLE_CMDS) /* 0x201C */
#define HCI_BLE_RECEIVER_TEST                   (0x001DU | HCI_GRP_BLE_CMDS) /* 0x201D */
#define HCI_BLE_TRANSMITTER_TEST                (0x001EU | HCI_GRP_BLE_CMDS) /* 0x201E */
#define HCI_BLE_TEST_END                        (0x001FU | HCI_GRP_BLE_CMDS) /* 0x201F */
#define HCI_BLE_RC_PARAM_REQ_REPLY              (0x0020U | HCI_GRP_BLE_CMDS) /* 0x2020 */
#define HCI_BLE_RC_PARAM_REQ_NEG_REPLY          (0x0021U | HCI_GRP_BLE_CMDS) /* 0x2021 */
#define HCI_BLE_SET_DATA_LENGTH                 (0x0022U | HCI_GRP_BLE_CMDS) /* 0x2022 */
#define HCI_BLE_READ_DFLT_DATA_LENGTH           (0x0023U | HCI_GRP_BLE_CMDS) /* 0x2023 */
#define HCI_BLE_WRITE_DFLT_DATA_LENGTH          (0x0024U | HCI_GRP_BLE_CMDS) /* 0x2024 */
#define HCI_BLE_ADD_DEV_RESOLVING_LIST          (0x0027U | HCI_GRP_BLE_CMDS) /* 0x2027 */
#define HCI_BLE_RM_DEV_RESOLVING_LIST           (0x0028U | HCI_GRP_BLE_CMDS) /* 0x2028 */
#define HCI_BLE_CLEAR_RESOLVING_LIST            (0x0029U | HCI_GRP_BLE_CMDS) /* 0x2029 */
#define HCI_BLE_READ_RESOLVING_LIST_SIZE        (0x002AU | HCI_GRP_BLE_CMDS) /* 0x202A */
#define HCI_BLE_READ_RESOLVABLE_ADDR_PEER       (0x002BU | HCI_GRP_BLE_CMDS) /* 0x202B */
#define HCI_BLE_READ_RESOLVABLE_ADDR_LOCAL      (0x002CU | HCI_GRP_BLE_CMDS) /* 0x202C */
#define HCI_BLE_SET_ADDR_RESOLUTION_ENABLE      (0x002DU | HCI_GRP_BLE_CMDS) /* 0x202D */
#define HCI_BLE_SET_RAND_PRIV_ADDR_TIMEOUT      (0x002EU | HCI_GRP_BLE_CMDS) /* 0x202E */
#define HCI_BLE_SET_RAND_PRIV_ADDR_TIMEOUT_V2   (0x009EU | HCI_GRP_BLE_CMDS) /* 0x209E */


#define HCI_BLE_READ_PHY                    (0x0030U | HCI_GRP_BLE_CMDS) /* 0x2030 */
#define HCI_BLE_SET_DEFAULT_PHY             (0x0031U | HCI_GRP_BLE_CMDS) /* 0x2031 */
#define HCI_BLE_SET_PHY                     (0x0032U | HCI_GRP_BLE_CMDS) /* 0x2032 */

/* ADV extension */
#define HCI_BLE_SET_ADV_SET_RANDOM_ADDR     (0x0035U | HCI_GRP_BLE_CMDS) /* 0x2035 */
#define HCI_BLE_SET_EXT_ADV_PARAMETERS      (0x0036U | HCI_GRP_BLE_CMDS) /* 0x2036 */
#define HCI_BLE_SET_EXT_ADV_DATA            (0x0037U | HCI_GRP_BLE_CMDS) /* 0x2037 */
#define HCI_BLE_SET_EXT_SCAN_RSP_DATA       (0x0038U | HCI_GRP_BLE_CMDS) /* 0x2038 */
#define HCI_BLE_SET_EXT_ADV_ENABLE          (0x0039U | HCI_GRP_BLE_CMDS) /* 0x2039 */
#define HCI_BLE_READ_MAX_ADV_DATA_LEN       (0x003AU | HCI_GRP_BLE_CMDS) /* 0x203A */
#define HCI_BLE_READ_NUM_OF_SUPPORTED_ADV_SETS   (0x003BU | HCI_GRP_BLE_CMDS) /* 0x203B */
#define HCI_BLE_REMOVE_ADV_SET              (0x003CU | HCI_GRP_BLE_CMDS) /* 0x203C */
#define HCI_BLE_CLEAR_ADV_SETS              (0x003DU | HCI_GRP_BLE_CMDS) /* 0x203D */
#define HCI_BLE_SET_PERIODIC_ADV_PARAMS     (0x003EU | HCI_GRP_BLE_CMDS) /* 0x203E */
#define HCI_BLE_SET_PERIODIC_ADV_DATA       (0x003FU | HCI_GRP_BLE_CMDS) /* 0x203F */
#define HCI_BLE_SET_PERIODIC_ADV_ENABLE     (0x0040U | HCI_GRP_BLE_CMDS) /* 0x2040 */
#define HCI_BLE_SET_EXT_SCAN_PARAMETERS     (0x0041U | HCI_GRP_BLE_CMDS) /* 0x2041 */

#define HCI_BLE_SET_EXT_SCAN_ENABLE         (0x0042U | HCI_GRP_BLE_CMDS) /* 0x2042 */
#define HCI_BLE_EXT_CREATE_CONNECTION       (0x0043U | HCI_GRP_BLE_CMDS) /* 0x2043 */
#define HCI_BLE_PERIODIC_ADV_CREATE_SYNC    (0x0044U | HCI_GRP_BLE_CMDS) /* 0x2044 */

#define HCI_BLE_PERIODIC_ADV_CREATE_SYNC_CANCEL (0x0045U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_PERIODIC_ADV_TERMINATE_SYNC     (0x0046U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ADD_DEV_TO_PERIODIC_ADV_LIST    (0x0047U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_REMOVE_DEV_FROM_PERIODIC_ADV_LIST   (0x0048U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_CLEAR_PERIODIC_ADV_LIST             (0x0049U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_READ_PERIODIC_ADV_LIST_SIZE         (0x004AU | HCI_GRP_BLE_CMDS)

#define HCI_BLE_SET_PRIVACY_MODE                 (0x004EU | HCI_GRP_BLE_CMDS)

#define HCI_BLE_SET_PERIODIC_ADV_RCV_ENABLE             (0x0059U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_PERIODIC_SYNC_XFER                      (0x005AU | HCI_GRP_BLE_CMDS)
#define HCI_BLE_PERIODIC_SET_INFO_XFER                  (0x005BU | HCI_GRP_BLE_CMDS)
#define HCI_BLE_SET_PERIODIC_SYNC_XFER_PARAMS           (0x005CU | HCI_GRP_BLE_CMDS)
#define HCI_BLE_SET_DETAULT_PERIODIC_SYNC_XFER_PARAMS   (0x005DU | HCI_GRP_BLE_CMDS)
#define HCI_LE_GENERATE_DHKEY_V2                        (0x005EU | HCI_GRP_BLE_CMDS)

#define HCI_BLE_READ_BUFFER_SIZE_V2         (0x0060U | HCI_GRP_BLE_CMDS)

/* LE ISOC */
#define HCI_BLE_ISOC_READ_TX_SYNC           (0x0061U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_SET_CIG_PARAM          (0x0062U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_SET_CIG_PARAM_TEST     (0x0063U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_CREATE_CIS             (0x0064U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_REMOVE_CIG             (0x0065U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_ACCEPT_CIS             (0x0066U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_REJECT_CIS             (0x0067U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_CREATE_BIG             (0x0068U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_CREATE_BIG_TEST        (0x0069U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_TERMINATE_BIG          (0x006AU | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_TERMINATE_BIG          (0x006AU | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_BIG_CREATE_SYNC        (0x006BU | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_BIG_TERMINATE_SYNC     (0x006CU | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_REQUEST_PEER_SCA       (0x006DU | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_SETUP_DATA_PATH        (0x006EU | HCI_GRP_BLE_CMDS)
#define HCI_BLE_ISOC_REMOVE_DATA_PATH       (0x006FU | HCI_GRP_BLE_CMDS)
#define HCI_BLE_SET_HOST_FEATURE            (0x0074U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_READ_ISOC_LINK_QUALITY      (0x0075U | HCI_GRP_BLE_CMDS)
#define HCI_BLE_READ_ALL_REMOTE_FEATURES    (0x0088U | HCI_GRP_BLE_CMDS)


#define HCI_LE_ENHANCED_READ_TRANSMIT_POWER_LEVEL           ( 0x76U  | HCI_GRP_BLE_CMDS)
#define HCI_LE_READ_REMOTE_TRANSMIT_POWER_LEVEL             ( 0x77U  | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_PATH_LOSS_REPORTING_PARAMETERS           ( 0x78U  | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_PATH_LOSS_REPORTING_ENABLE               ( 0x79U  | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_TRANSMIT_POWER_REPORTING_ENABLE          ( 0x7AU  | HCI_GRP_BLE_CMDS)
#define HCI_LE_TRANSMITTER_TEST_V4                          ( 0x7BU  | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_DATA_RELATED_ADDRESS_CHANGES             ( 0x7CU  | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_DEFAULT_SUBRATE_REQUEST                  ( 0x7DU  | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_SUBRATE_REQUEST                          ( 0x7EU  | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_EXTENDED_ADVERTISING_PARAMETERS_V2       ( 0x7FU  | HCI_GRP_BLE_CMDS)

#define HCI_LE_SET_DECISION_DATA                            (0x80U | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_DECISION_INSTRUCTIONS                    (0x81U | HCI_GRP_BLE_CMDS)

/* PAWR */
#define HCI_LE_SET_PERIODIC_ADVERTISING_SUBEVENT_DATA       ( 0x82U  | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_PERIODIC_ADVERTISING_RESPONSE_DATA       ( 0x83U  | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_PERIODIC_SYNC_SUBEVENT                   ( 0x84U  | HCI_GRP_BLE_CMDS)
#define HCI_LE_EXTENDED_CREATE_CONNECTION_V2                ( 0x85U  | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_PERIODIC_ADVERTISING_PARAMETERS_V2       ( 0x86U  | HCI_GRP_BLE_CMDS)

#define HCI_LE_CS_READ_LOCAL_SUPPORTED_CAPABILITIES          (0x89U | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_READ_REMOTE_SUPPORTED_CAPABILITIES         (0x8AU | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_WRITE_CACHED_REMOTE_SUPPORTED_CAPABILITIES (0x8BU | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_SECURITY_ENABLE                            (0x8CU | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_SET_DEFAULT_SETTINGS                       (0x8DU | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_READ_REMOTE_FAE_TABLE                      (0x8EU | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_WRITE_CACHED_REMOTE_FAE_TABLE              (0x8FU | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_CREATE_CONFIG                              (0x90U | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_REMOVE_CONFIG                              (0x91U | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_SET_CHANNEL_CLASSIFICATION                 (0x92U | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_SET_PROCEDURE_PARAMETERS                   (0x93U | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_SET_PROCEDURE_ENABLE                       (0x94U | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_TEST                                       (0x95U | HCI_GRP_BLE_CMDS)
#define HCI_LE_CS_TEST_END                                   (0x96U | HCI_GRP_BLE_CMDS)
#define HCI_LE_SET_HOST_FEATURE_V2                           (0x97U | HCI_GRP_BLE_CMDS)

#define HCI_LE_ADD_DEVICE_TO_MONITORED_ADVERTISERS_LIST      (0x98U | HCI_GRP_BLE_CMDS)
#define HCI_LE_REMOVE_DEVICE_FROM_MONITORED_ADVERTISERS_LIST (0x99U | HCI_GRP_BLE_CMDS)
#define HCI_LE_CLEAR_MONITORED_ADVERTISERS_LIST              (0x9AU | HCI_GRP_BLE_CMDS)
#define HCI_LE_READ_MONITORED_ADVERTISERS_LIST_SIZE          (0x9BU | HCI_GRP_BLE_CMDS)
#define HCI_LE_ENABLE_MONITORING_ADVERTISERS                 (0x9CU | HCI_GRP_BLE_CMDS)
#define HCI_LE_FRAME_SPACE_UPDATE                            (0x9DU | HCI_GRP_BLE_CMDS)


/* LE supported states definition */
#define HCI_LE_ADV_STATE          0x00000001U
#define HCI_LE_SCAN_STATE         0x00000002U
#define HCI_LE_INIT_STATE         0x00000004U
#define HCI_LE_CONN_SL_STATE      0x00000008U
#define HCI_LE_ADV_SCAN_STATE     0x00000010U
#define HCI_LE_ADV_INIT_STATE     0x00000020U
#define HCI_LE_ADV_MA_STATE       0x00000040U
#define HCI_LE_ADV_SL_STATE       0x00000080U
#define HCI_LE_SCAN_INIT_STATE    0x00000100U
#define HCI_LE_SCAN_MA_STATE      0x00000200U
#define HCI_LE_SCAN_SL_STATE      0x00000400U
#define HCI_LE_INIT_MA_STATE      0x00000800U
...
*/
#define HCI_INQUIRY_COMP_EVT                0x01U
#define HCI_INQUIRY_RESULT_EVT              0x02U
#define HCI_CONNECTION_COMP_EVT             0x03U
#define HCI_CONNECTION_REQUEST_EVT          0x04U
#define HCI_DISCONNECTION_COMP_EVT          0x05U
#define HCI_AUTHENTICATION_COMP_EVT         0x06U
#define HCI_RMT_NAME_REQUEST_COMP_EVT       0x07U
#define HCI_ENCRYPTION_CHANGE_EVT           0x08U
#define HCI_CHANGE_CONN_LINK_KEY_EVT        0x09U
#define HCI_TEMP_LINK_KEY_COMP_EVT          0x0AU
#define HCI_READ_RMT_FEATURES_COMP_EVT      0x0BU
#define HCI_READ_RMT_VERSION_COMP_EVT       0x0CU
#define HCI_QOS_SETUP_COMP_EVT              0x0DU
#define HCI_COMMAND_COMPLETE_EVT            0x0EU
#define HCI_COMMAND_STATUS_EVT              0x0FU
#define HCI_HARDWARE_ERROR_EVT              0x10U
#define HCI_FLUSH_OCCURED_EVT               0x11U
#define HCI_ROLE_CHANGE_EVT                 0x12U
#define HCI_NUM_COMPL_DATA_PKTS_EVT         0x13U
#define HCI_MODE_CHANGE_EVT                 0x14U
#define HCI_RETURN_LINK_KEYS_EVT            0x15U
#define HCI_PIN_CODE_REQUEST_EVT            0x16U
#define HCI_LINK_KEY_REQUEST_EVT            0x17U
#define HCI_LINK_KEY_NOTIFICATION_EVT       0x18U
#define HCI_LOOPBACK_COMMAND_EVT            0x19U
#define HCI_DATA_BUF_OVERFLOW_EVT           0x1AU
#define HCI_MAX_SLOTS_CHANGED_EVT           0x1BU
#define HCI_READ_CLOCK_OFF_COMP_EVT         0x1CU
#define HCI_CONN_PKT_TYPE_CHANGE_EVT        0x1DU
#define HCI_QOS_VIOLATION_EVT               0x1EU
#define HCI_PAGE_SCAN_MODE_CHANGE_EVT       0x1FU
#define HCI_PAGE_SCAN_REP_MODE_CHNG_EVT     0x20U
#define HCI_FLOW_SPECIFICATION_COMP_EVT     0x21U
#define HCI_INQUIRY_RSSI_RESULT_EVT         0x22U
#define HCI_READ_RMT_EXT_FEATURES_COMP_EVT  0x23U
#define HCI_ESCO_CONNECTION_COMP_EVT        0x2CU
#define HCI_ESCO_CONNECTION_CHANGED_EVT     0x2DU
#define HCI_SNIFF_SUB_RATE_EVT              0x2EU
#define HCI_EXTENDED_INQUIRY_RESULT_EVT     0x2FU
#define HCI_ENCRYPTION_KEY_REFRESH_COMP_EVT 0x30U
#define HCI_IO_CAPABILITY_REQUEST_EVT       0x31U
#define HCI_IO_CAPABILITY_RESPONSE_EVT      0x32U
#define HCI_USER_CONFIRMATION_REQUEST_EVT   0x33U
#define HCI_USER_PASSKEY_REQUEST_EVT        0x34U
#define HCI_REMOTE_OOB_DATA_REQUEST_EVT     0x35U
#define HCI_SIMPLE_PAIRING_COMPLETE_EVT     0x36U
#define HCI_LINK_SUPER_TOUT_CHANGED_EVT     0x38U
#define HCI_ENHANCED_FLUSH_COMPLETE_EVT     0x39U
#define HCI_USER_PASSKEY_NOTIFY_EVT         0x3BU
#define HCI_KEYPRESS_NOTIFY_EVT             0x3CU
#define HCI_RMT_HOST_SUP_FEAT_NOTIFY_EVT    0x3DU

/*#define HCI_GENERIC_AMP_LINK_KEY_NOTIF_EVT  0x3E Removed from spec */
#define HCI_PHYSICAL_LINK_COMP_EVT          0x40U
#define HCI_CHANNEL_SELECTED_EVT            0x41U
#define HCI_DISC_PHYSICAL_LINK_COMP_EVT     0x42U
#define HCI_PHY_LINK_LOSS_EARLY_WARNING_EVT 0x43U
#define HCI_PHY_LINK_RECOVERY_EVT           0x44U
#define HCI_LOGICAL_LINK_COMP_EVT           0x45U
#define HCI_DISC_LOGICAL_LINK_COMP_EVT      0x46U
#define HCI_FLOW_SPEC_MODIFY_COMP_EVT       0x47U
#define HCI_NUM_COMPL_DATA_BLOCKS_EVT       0x48U
#define HCI_SHORT_RANGE_MODE_COMPLETE_EVT   0x4CU
#define HCI_AMP_STATUS_CHANGE_EVT           0x4DU
#define HCI_SET_TRIGGERED_CLOCK_CAPTURE_EVT 0x4EU



/* ULP HCI Event */
#define HCI_BLE_EVENT                               0x3eU
/* ULP Event sub code */
#define HCI_BLE_CONN_COMPLETE_EVT                   0x01U
#define HCI_BLE_ADV_PKT_RPT_EVT                     0x02U
#define HCI_BLE_LL_CONN_PARAM_UPD_EVT               0x03U
#define HCI_BLE_READ_REMOTE_FEAT_COMPLETE_EVT       0x04U
#define HCI_BLE_LTK_REQ_EVT                         0x05U
#define HCI_BLE_RC_PARAM_REQ_EVT                    0x06U
#define HCI_BLE_DATA_LENGTH_CHANGE_EVT              0x07U
#define HCI_BLE_ENHANCED_CONN_COMPLETE_EVT          0x0aU
#define HCI_BLE_DIRECT_ADV_EVT                      0x0bU
#define HCI_BLE_PHY_UPDATE_COMPLETE_EVT             0x0cU
#define HCI_BLE_EXT_ADV_REPORT_EVT                  0x0dU
#define HCI_BLE_PERIODIC_ADV_SYNC_ESTABLISHED_EVT   0x0eU
#define HCI_BLE_PERIODIC_ADV_REPORT_EVT             0x0fU
#define HCI_BLE_PERIODIC_SYNC_LOST_EVT              0x10U
#define HCI_BLE_EXT_SCAN_TIMEOUT_EVT                0x11U
#define HCI_BLE_ADV_SET_TERMINATED_EVT              0x12U
#define HCI_BLE_SCAN_REQ_RECEIVED_EVT               0x13U
#define HCI_BLE_CHANNEL_SELECTION_ALOGRITHM_EVT     0x14U
#define HCI_BLE_PERIODIC_ADV_SYNC_XFER_RECV_EVT     0x18U

#define HCI_BLE_ISOC_CIS_ESTABLISHED_EVT            0x19U
#define HCI_BLE_ISOC_CIS_ESTABLISHED_V2_EVT         0x2AU
#define HCI_BLE_ISOC_CIS_REQUEST_EVT                0x1AU
#define HCI_BLE_ISOC_CREATE_BIG_EVT                 0x1BU
#define HCI_BLE_ISOC_TERMINATE_BIG_EVT              0x1CU
#define HCI_BLE_ISOC_BIG_SYNC_ESTABLISHED_EVT       0x1DU
#define HCI_BLE_ISOC_BIG_SYNC_LOST_EVT              0x1EU
#define HCI_BLE_ISOC_PEER_SCA_COMPLETE_EVT          0x1FU
#define HCI_BLE_BIGINFO_ADV_REPORT_EVT              0x22U
#define HCI_BLE_SUBRATE_CHANGE_EVT                  0x23U

/* PAWR */
#define HCI_BLE_PAWR_SYNC_ESTABLISHED_EVT           0x24U
#define HCI_BLE_PAWR_IND_REPORT_EVT                 0x25U
#define HCI_BLE_PAWR_SYNC_XFER_RECV_EVT             0x26U
#define HCI_BLE_PAWR_SUBEVENT_DATA_REQ_EVT          0x27U
#define HCI_BLE_PAWR_RSP_REPORT_EVT                 0x28U
#define HCI_BLE_ENHANCED_CONN_COMPLETE_V2_EVT       0x29U

#define HCI_BLE_READ_ALL_REMOTE_FEAT_COMPLETE_EVT   0x2BU

/* CS */
#define HCI_LE_CS_READ_REMOTE_SUPPORTED_CAPABILITIES_COMPLETE 0x2cU
#define HCI_LE_CS_READ_REMOTE_FAE_TABLE_COMPLETE    0x2DU
#define HCI_LE_CS_READ_SECURITY_ENABLE_COMPLETE     0x2EU

#define HCI_LE_CS_CONFIG_COMPLETE                   0x2FU
#define HCI_LE_CS_PROCEDURE_ENABLE_COMPLETE         0x30U
#define HCI_LE_CS_SUBEVENT_RESULT_EVT               0x31U
#define HCI_LE_CS_SUBEVENT_RESULT_CONTINUE_EVT      0x32U
#define HCI_LE_CS_TEST_END_COMPLETE                 0x33U
#define HCI_LE_CS_READ_REMOTE_SUPPORTED_CAPABILITIES_COMPLETE_V2 0x38U

/* ConnectionLess Broadcast events */
#define HCI_SYNC_TRAIN_COMP_EVT             0x4FU
#define HCI_SYNC_TRAIN_RECEIVED_EVT         0x50U
#define HCI_CLB_RX_DATA_EVT                 0x51U
#define HCI_CLB_RX_TIMEOUT_EVT              0x52U
#define HCI_TRUNCATED_PAGE_COMP_EVT         0x53U
#define HCI_PERIPHERAL_PAGE_RESP_TIMEOUT_EVT     0x54U
#define HCI_CLB_CHANNEL_CHANGE_EVT          0x55U
#define HCI_INQUIRY_RESPONSE_NOTIF          0x56U

/* Secure Connections events */
#define HCI_AUTHENT_PAYLOAD_TOUT_EVT        0x57U

#define HCI_EVENT_RSP_FIRST                 HCI_INQUIRY_COMP_EVT
#define HCI_EVENT_RSP_LAST                  HCI_AUTHENT_PAYLOAD_TOUT_EVT

#define HCI_VENDOR_SPECIFIC_EVT             0xFFU  /* Vendor specific events */
#define HCI_NAP_TRACE_EVT                   0xFFU  /* was define 0xFE, 0xFD, change to 0xFF
                                                 because conflict w/ TCI_EVT and per
                                                 specification compliant */

#define HCI_BLE_READ_REMOTE_FEAT_CMPL_EVT           0x04U /** @deprecated*/


/*
**  Defentions for HCI Error Codes that are past in the events
*/
#define HCI_SUCCESS                                     0x00U
#define HCI_PENDING                                     0x00U
#define HCI_ERR_ILLEGAL_COMMAND                         0x01U
#define HCI_ERR_NO_CONNECTION                           0x02U
#define HCI_ERR_HW_FAILURE                              0x03U
#define HCI_ERR_PAGE_TIMEOUT                            0x04U
#define HCI_ERR_AUTH_FAILURE                            0x05U
#define HCI_ERR_KEY_MISSING                             0x06U
#define HCI_ERR_MEMORY_FULL                             0x07U
#define HCI_ERR_CONNECTION_TOUT                         0x08U
#define HCI_ERR_MAX_NUM_OF_CONNECTIONS                  0x09U
#define HCI_ERR_MAX_NUM_OF_SCOS                         0x0AU
#define HCI_ERR_CONNECTION_EXISTS                       0x0BU
#define HCI_ERR_COMMAND_DISALLOWED                      0x0CU
#define HCI_ERR_HOST_REJECT_RESOURCES                   0x0DU
#define HCI_ERR_HOST_REJECT_SECURITY                    0x0EU
#define HCI_ERR_HOST_REJECT_DEVICE                      0x0FU
#define HCI_ERR_HOST_TIMEOUT                            0x10U
#define HCI_ERR_UNSUPPORTED_VALUE                       0x11U
#define HCI_ERR_ILLEGAL_PARAMETER_FMT                   0x12U
#define HCI_ERR_PEER_USER                               0x13U
#define HCI_ERR_PEER_LOW_RESOURCES                      0x14U
#define HCI_ERR_PEER_POWER_OFF                          0x15U
#define HCI_ERR_CONN_CAUSE_LOCAL_HOST                   0x16U
#define HCI_ERR_REPEATED_ATTEMPTS                       0x17U
#define HCI_ERR_PAIRING_NOT_ALLOWED                     0x18U
#define HCI_ERR_UNKNOWN_LMP_PDU                         0x19U
#define HCI_ERR_UNSUPPORTED_REM_FEATURE                 0x1AU
#define HCI_ERR_SCO_OFFSET_REJECTED                     0x1BU
#define HCI_ERR_SCO_INTERVAL_REJECTED                   0x1CU
#define HCI_ERR_SCO_AIR_MODE                            0x1DU
#define HCI_ERR_INVALID_LMP_PARAM                       0x1EU
#define HCI_ERR_UNSPECIFIED                             0x1FU
#define HCI_ERR_UNSUPPORTED_LMP_FEATURE                 0x20U
#define HCI_ERR_ROLE_CHANGE_NOT_ALLOWED                 0x21U
#define HCI_ERR_LMP_RESPONSE_TIMEOUT                    0x22U
#define HCI_ERR_LMP_ERR_TRANS_COLLISION                 0x23U
#define HCI_ERR_LMP_PDU_NOT_ALLOWED                     0x24U
#define HCI_ERR_ENCRY_MODE_NOT_ACCEPTABLE               0x25U
#define HCI_ERR_UNIT_KEY_USED                           0x26U
#define HCI_ERR_QOS_NOT_SUPPORTED                       0x27U
#define HCI_ERR_INSTANT_PASSED                          0x28U
#define HCI_ERR_PAIRING_WITH_UNIT_KEY_NOT_SUPPORTED     0x29U
#define HCI_ERR_DIFF_TRANSACTION_COLLISION              0x2AU
#define HCI_ERR_UNDEFINED_0x2B                          0x2BU
#define HCI_ERR_QOS_UNACCEPTABLE_PARAM                  0x2CU
#define HCI_ERR_QOS_REJECTED                            0x2DU
#define HCI_ERR_CHAN_CLASSIF_NOT_SUPPORTED              0x2EU
#define HCI_ERR_INSUFFCIENT_SECURITY                    0x2FU
#define HCI_ERR_PARAM_OUT_OF_RANGE                      0x30U
#define HCI_ERR_UNDEFINED_0x31                          0x31U
#define HCI_ERR_ROLE_SWITCH_PENDING                     0x32U
#define HCI_ERR_UNDEFINED_0x33                          0x33U
#define HCI_ERR_RESERVED_SLOT_VIOLATION                 0x34U
#define HCI_ERR_ROLE_SWITCH_FAILED                      0x35U
#define HCI_ERR_INQ_RSP_DATA_TOO_LARGE                  0x36U
#define HCI_ERR_SIMPLE_PAIRING_NOT_SUPPORTED            0x37U
#define HCI_ERR_HOST_BUSY_PAIRING                       0x38U
#define HCI_ERR_REJ_NO_SUITABLE_CHANNEL                 0x39U
#define HCI_ERR_CONTROLLER_BUSY                         0x3AU
#define HCI_ERR_UNACCEPT_CONN_INTERVAL                  0x3BU
#define HCI_ERR_DIRECTED_ADVERTISING_TIMEOUT            0x3CU
#define HCI_ERR_CONN_TOUT_DUE_TO_MIC_FAILURE            0x3DU
#define HCI_ERR_CONN_FAILED_ESTABLISHMENT               0x3EU
#define HCI_ERR_MAC_CONNECTION_FAILED                   0x3FU

/* ConnectionLess Broadcast errors */
#define HCI_ERR_LT_ADDR_ALREADY_IN_USE                  0x40U
#define HCI_ERR_LT_ADDR_NOT_ALLOCATED                   0x41U
#define HCI_ERR_CLB_NOT_ENABLED                         0x42U
#define HCI_ERR_CLB_DATA_TOO_BIG                        0x43U

#define HCI_ERR_MAX_ERR                                 0x43U

#define HCI_HINT_TO_RECREATE_AMP_PHYS_LINK              0xFFU

/*
** Definitions for HCI enable event
*/
#define HCI_INQUIRY_COMPLETE_EV(p)          (*((uint32_t *)(p)) & 0x00000001U)
#define HCI_INQUIRY_RESULT_EV(p)            (*((uint32_t *)(p)) & 0x00000002U)
#define HCI_CONNECTION_COMPLETE_EV(p)       (*((uint32_t *)(p)) & 0x00000004U)
#define HCI_CONNECTION_REQUEST_EV(p)        (*((uint32_t *)(p)) & 0x00000008U)
#define HCI_DISCONNECTION_COMPLETE_EV(p)    (*((uint32_t *)(p)) & 0x00000010U)
#define HCI_AUTHENTICATION_COMPLETE_EV(p)   (*((uint32_t *)(p)) & 0x00000020U)
#define HCI_RMT_NAME_REQUEST_COMPL_EV(p)    (*((uint32_t *)(p)) & 0x00000040U)
#define HCI_CHANGE_CONN_ENCRPT_ENABLE_EV(p) (*((uint32_t *)(p)) & 0x00000080U)
#define HCI_CHANGE_CONN_LINK_KEY_EV(p)      (*((uint32_t *)(p)) & 0x00000100U)
#define HCI_CENTRAL_LINK_KEY_COMPLETE_EV(p) (*((uint32_t *)(p)) & 0x00000200U)
#define HCI_READ_RMT_FEATURES_COMPL_EV(p)   (*((uint32_t *)(p)) & 0x00000400U)
#define HCI_READ_RMT_VERSION_COMPL_EV(p)    (*((uint32_t *)(p)) & 0x00000800U)
#define HCI_QOS_SETUP_COMPLETE_EV(p)        (*((uint32_t *)(p)) & 0x00001000U)
#define HCI_COMMAND_COMPLETE_EV(p)          (*((uint32_t *)(p)) & 0x00002000U)
#define HCI_COMMAND_STATUS_EV(p)            (*((uint32_t *)(p)) & 0x00004000U)
#define HCI_HARDWARE_ERROR_EV(p)            (*((uint32_t *)(p)) & 0x00008000U)
#define HCI_FLASH_OCCURED_EV(p)             (*((uint32_t *)(p)) & 0x00010000U)
#define HCI_ROLE_CHANGE_EV(p)               (*((uint32_t *)(p)) & 0x00020000U)
#define HCI_NUM_COMPLETED_PKTS_EV(p)        (*((uint32_t *)(p)) & 0x00040000U)
#define HCI_MODE_CHANGE_EV(p)               (*((uint32_t *)(p)) & 0x00080000U)
#define HCI_RETURN_LINK_KEYS_EV(p)          (*((uint32_t *)(p)) & 0x00100000U)
#define HCI_PIN_CODE_REQUEST_EV(p)          (*((uint32_t *)(p)) & 0x00200000U)
#define HCI_LINK_KEY_REQUEST_EV(p)          (*((uint32_t *)(p)) & 0x00400000U)
#define HCI_LINK_KEY_NOTIFICATION_EV(p)     (*((uint32_t *)(p)) & 0x00800000U)
#define HCI_LOOPBACK_COMMAND_EV(p)          (*((uint32_t *)(p)) & 0x01000000U)
#define HCI_DATA_BUF_OVERFLOW_EV(p)         (*((uint32_t *)(p)) & 0x02000000U)
#define HCI_MAX_SLOTS_CHANGE_EV(p)          (*((uint32_t *)(p)) & 0x04000000U)
#define HCI_READ_CLOCK_OFFSET_COMP_EV(p)    (*((uint32_t *)(p)) & 0x08000000U)
#define HCI_CONN_PKT_TYPE_CHANGED_EV(p)     (*((uint32_t *)(p)) & 0x10000000U)
#define HCI_QOS_VIOLATION_EV(p)             (*((uint32_t *)(p)) & 0x20000000U)
#define HCI_PAGE_SCAN_MODE_CHANGED_EV(p)    (*((uint32_t *)(p)) & 0x40000000U)
#define HCI_PAGE_SCAN_REP_MODE_CHNG_EV(p)   (*((uint32_t *)(p)) & 0x80000000U)

/* the default event mask for 2.1+EDR (Lisbon) does not include Lisbon events */
#define HCI_DEFAULT_EVENT_MASK_0            0xFFFFFFFFU
#define HCI_DEFAULT_EVENT_MASK_1            0x00001FFFU

/* the event mask for 2.0 + EDR and later (includes Lisbon events) */
#define HCI_LISBON_EVENT_MASK_0             0xFFFFFFFFU
#define HCI_LISBON_EVENT_MASK_1             0x1DBFFFFFU
...
#define HCI_QOS_LATENCY_DO_NOT_CARE     0xFFFFFFFFU
#define HCI_QOS_DELAY_DO_NOT_CARE       0xFFFFFFFFU

/* Definitions for Flow Specification */
#define HCI_FLOW_SPEC_LATENCY_DO_NOT_CARE 0xFFFFFFFFU
...
/*
   LE features encoding - page 3
*/
/* Channel Sounding Enhancement #1: bit 75 */
#define HCI_LE_FEATURE_REMOTE_CS_ENHANCEMENTS_MASK (0x08)
#define HCI_LE_FEATURE_REMOTE_CS_ENHANCEMENTS_OFF  (9)
#define HCI_LE_FEATURE_REMOTE_CS_ENHANCEMENTS_SUPPORTED(x)                         \
    ((x)[HCI_LE_FEATURE_REMOTE_CS_ENHANCEMENTS_OFF] & HCI_LE_FEATURE_REMOTE_CS_ENHANCEMENTS_MASK)
...
#define HCI_SUPP_COMMANDS_LE_READ_BUFFER_SIZE_V2_MASK          0x20
#define HCI_SUPP_COMMANDS_LE_READ_BUFFER_SIZE_V2_OFF           41
#define HCI_LE_READ_BUFFER_SIZE_V2_SUPPORTED(x)      ((x)[HCI_SUPP_COMMANDS_LE_READ_BUFFER_SIZE_V2_OFF] & HCI_SUPP_COMMANDS_LE_READ_BUFFER_SIZE_V2_MASK)
...
#define HCI_SUPP_COMMANDS_LE_READ_ALL_REMOTE_FEATURES_MASK          0x08
#define HCI_SUPP_COMMANDS_LE_READ_ALL_REMOTE_FEATURES_OFF           47
#define HCI_LE_READ_ALL_REMOTE_FEATURES_SUPPORTED(x)      ((x)[HCI_SUPP_COMMANDS_LE_READ_ALL_REMOTE_FEATURES_OFF] & HCI_SUPP_COMMANDS_LE_READ_ALL_REMOTE_FEATURES_MASK)
